...
for iteration in range(ITERS):
    ...
    for iter_d in range(CRITIC_ITERS):
        ...
        # D tries to maximize wasserstein_distance
        # train with real
    ...
    if iteration % 100000 == 0 and iteration:
        torch.save(netG.state_dict(), 'model/netG100000.txt')
        torch.save(netD.state_dict(), 'model/netD100000.txt')
